...
static vec3 CamLight(1,1,1);
static double CamLightW = 1.5;
static double CamLightMin =  0.48193;
//-----------------------------------
static const vec3 baseColor(0, 0.5, 1);
static const vec3 backColor(0.847058824,0.749019608,0.847058824);
//-----------------------------------
  ...
  if (pixData.escaped == false) 
    {
      ...
      if(render_params.colourType == 0 || render_params.colourType == 100)
	{
